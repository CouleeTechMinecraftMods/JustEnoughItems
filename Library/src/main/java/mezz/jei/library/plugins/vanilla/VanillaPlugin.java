...
public class VanillaPlugin implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration.addRecipes(RecipeTypes.SMELTING_FUEL, FuelRecipeMaker.getFuelRecipes(ingredientManager, net.minecraft.world.item.crafting.RecipeType.SMELTING));
		registration.addRecipes(RecipeTypes.SMOKING_FUEL, FuelRecipeMaker.getFuelRecipes(ingredientManager, net.minecraft.world.item.crafting.RecipeType.SMOKING));
		registration.addRecipes(RecipeTypes.BLASTING_FUEL, FuelRecipeMaker.getFuelRecipes(ingredientManager, net.minecraft.world.item.crafting.RecipeType.BLASTING));
